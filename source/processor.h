...
namespace LAMELLA_INST {
	...
	//  LamellaProcessor
	//------------------------------------------------------------------------
	class LamellaProcessor : public Steinberg::Vst::AudioEffect
	{
	public:
		LamellaProcessor();
		~LamellaProcessor() SMTG_OVERRIDE;

		// Create function
		static Steinberg::FUnknown* createInstance(void* /*context*/)
		{
			return (Steinberg::Vst::IAudioProcessor*)new LamellaProcessor;
		}
		...
		void getMidi(Steinberg::Vst::IEventList* Events);
	...
	protected:
		...
		Steinberg::Vst::DataExchangeBlock currentExchangeBlock;
		int counter = 0;
	};
